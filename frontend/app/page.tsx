...
export default function LandingPage() {
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative overflow-hidden pt-16 pb-20 lg:pt-24 lg:pb-32">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/dashboard">
              <Button size="lg" className="w-full sm:w-auto text-base gap-2 px-6">
                Start Free Financial Assessment
                <ArrowRight className="w-4 h-4" />
              </Button>
            </Link>
            <Link href="/advisor">
              <Button size="lg" variant="outline" className="w-full sm:w-auto text-base gap-2 px-6">
          ...
          <div className="mt-14 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
            <div className="p-4 rounded-xl bg-slate-900/60 border border-slate-800">
              <p className="text-2xl font-bold text-emerald-400">₹0 Hallucination</p>
              <p className="text-xs text-slate-400 mt-1">100% Math-Verified Rules</p>
            </div>
            <div className="p-4 rounded-xl bg-slate-900/60 border border-slate-800">
              <p className="text-2xl font-bold text-sky-400">384-Dim Vector</p>
              <p className="text-xs text-slate-400 mt-1">SEBI & RBI RAG Knowledge</p>
            </div>
            <div className="p-4 rounded-xl bg-slate-900/60 border border-slate-800">
              <p className="text-2xl font-bold text-amber-400">Multi-Factor</p>
              <p className="text-xs text-slate-400 mt-1">Risk Scoring (0–100)</p>
            </div>
            <div className="p-4 rounded-xl bg-slate-900/60 border border-slate-800">
              <p className="text-2xl font-bold text-purple-400">Finance Act 2024</p>
              <p className="text-xs text-slate-400 mt-1">Capital Gains Tax Rules</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="features" className="py-20 border-t border-slate-800/80 bg-slate-900/40">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="hover:border-emerald-500/50 transition-colors">
              <CardContent className="p-6 space-y-4">
                ...
                <h3 className="text-lg font-semibold text-slate-100">1. Deterministic Engine</h3>
            ...
            <Card className="hover:border-sky-500/50 transition-colors">
              <CardContent className="p-6 space-y-4">
                ...
                <h3 className="text-lg font-semibold text-slate-100">2. Knowledge RAG Pipeline</h3>
                <p className="text-xs text-slate-400 leading-relaxed">
                ...
                <div className="text-xs text-sky-400 font-medium pt-2">
            ...
            <Card className="hover:border-amber-500/50 transition-colors">
              <CardContent className="p-6 space-y-4">
                ...
                <h3 className="text-lg font-semibold text-slate-100">3. Explainable Portfolios</h3>
                <p className="text-xs text-slate-400 leading-relaxed">
                ...
                <div className="text-xs text-amber-400 font-medium pt-2">
      ...
      <section id="how-it-works" className="py-20 border-t border-slate-800/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="text-2xl sm:text-3xl font-bold text-white">How ArthaAI Works</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={item.step} className="p-5 rounded-xl bg-slate-900/60 border border-slate-800 relative">
                <span className="text-3xl font-black text-slate-800 block mb-2">{item.step}</span>
      ...
      {/* Security & Privacy */}
      <section id="security" className="py-20 border-t border-slate-800/80 bg-slate-900/40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto rounded-2xl bg-gradient-to-b from-slate-900 to-slate-950 border border-slate-800 p-8 sm:p-12 text-center space-y-6">
            <div className="w-12 h-12 rounded-full bg-emerald-500/10 flex items-center justify-center text-emerald-400 mx-auto border border-emerald-500/20">
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 pt-2 text-xs text-slate-300">
              <span className="flex items-center gap-1.5"><CheckCircle2 className="w-4 h-4 text-emerald-400" /> Transparent Formulas</span>
              <span className="flex items-center gap-1.5"><CheckCircle2 className="w-4 h-4 text-emerald-400" /> SEBI-Aligned Categories</span>
              <span className="flex items-center gap-1.5"><CheckCircle2 className="w-4 h-4 text-emerald-400" /> No Unchecked AI Trading</span>
            </div>
